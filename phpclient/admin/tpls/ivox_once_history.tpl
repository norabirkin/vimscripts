...
<body>
  <table cellpadding="0" cellspacing="0" border="0" align="center" width="800">
    <tr>
     <th colspan="5" width="800" height="30" class="z11" style="border: solid 1px #c0c0c0;">
       <font class=z11>История назначения услуг учетной записи {VG_LOGIN}</font>
     </th>
    </tr>
    <tr>
        ...
        <th bgcolor="#e0e0e0" width="15%" height="25" class="z11" align="center" style="border-bottom: solid 1px #c0c0c0; border-right: solid 1px #c0c0c0;">
     ...
     <tr>
        ...
        <td width="15%" height="25 class="z11" align="center" style="border-bottom: solid 1px #c0c0c0; border-right: solid 1px #c0c0c0;">
  ...
  <table cellpadding="0" cellspacing="0" border="0" align="center" width="800">
    ...
    <tr>
     ...
     <th  width="20%" align="center" height="25" class="z11" style="border: solid 1px #c0c0c0; border-top: none; border-left: none;">
