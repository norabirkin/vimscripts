/**
 * @class Printer
 * Class providing a common way of printing Ext.Components. Printer.print delegates the printing to a specialised
 * renderer class (each of which subclasses Printer.BaseRenderer), based on the xtype of the component.
...
/**
* @class Printer.ColumnTreeRenderer
* @extends Printer.BaseRenderer
* @author Ed Spencer
* Helper class to easily print the contents of a column tree
*/
Printer.ColumnTreeRenderer = Ext.extend(Printer.BaseRenderer, {
...
Printer.registerRenderer('columntree', Printer.ColumnTreeRenderer);

/**
* @class Printer.GridPanelRenderer
* @extends Printer.BaseRenderer
* @author Ed Spencer
...
*/
Printer.GridPanelRenderer = Ext.extend(Printer.BaseRenderer, {
    ...
    getColumns: function(grid) {
        ...
        Ext.each(grid.getColumnModel().config, function(col) {
            if (col.hidden != true && col.printable != false) columns.push(col);
        }, this);
        return columns;
    },
...
Printer.registerRenderer('grid', Printer.GridPanelRenderer);

Print = function(grid) {Printer.print(grid); }