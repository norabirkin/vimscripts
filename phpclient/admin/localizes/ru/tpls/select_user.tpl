...
{
	try {
	var form = parent.opener.document.getElementById('_vgroup');
	form.uid.value = uidd;
	form.vg_user.value = uidd;
	parent.opener.document.getElementById('_vg_user_fio_').innerHTML = fio;
	form.vg_user_fio.value = fio;
...
<table class="table_comm" cellpadding="0" cellspacing="0" border="0" width="600" align="center">
   <tr>
   	<th class="z11" width="250" height="30" bgcolor="e0e0e0"
