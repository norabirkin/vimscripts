...
<table class="table_comm"  align="center" width="985">

<!-- BEGIN reports_list -->
<tr>
  <td colspan=3 align="center" class="td_head_ext" width="985" style="border: solid 1px #c0c0c0;">
    <b>{SHOW_REP_LIST}</b>
  </td>
</tr>
<tr>
  <td align="center"  width="325" height="50" style="border-left: solid 1px #c0c0c0; border-bottom: solid 1px #c0c0c0;">
   <input type="submit" name=create class=z11 style="width: 100px;" value="Создать" onCLick="document.forms[1].whatpressed.value=1">
  </td>
  <td align="center"  width="330" style="border-bottom: solid 1px #c0c0c0;">
  ...
  <td align="center"  width="330" style="border-right: solid 1px #c0c0c0; border-bottom: solid 1px #c0c0c0;">
...
<tr><td colspan="3"><table align="center" cellpadding="0" cellspacing="0" border="0" width=985>
 <tr align="center">
 <td width="30" class="z11" height="20" bgcolor="#e0e0e0" style=" border-bottom: solid 1px #c0c0c0;">&nbsp;
  
 </td>
 <td width="40" class="z11" height="20" bgcolor="#e0e0e0" style="border-bottom: solid 1px #c0c0c0;">
  <font class=z11><b>№</b></font>
 </td>
 <td width="300" class="z11" height="20" bgcolor="#e0e0e0" style="border-bottom: solid 1px #c0c0c0;">
  <font class=z11><b>Название</b></font>
 </td>
 <td class="z11" height="20" bgcolor="#e0e0e0" style="border-right: solid 1px #c0c0c0; border-bottom: solid 1px #c0c0c0;">
  <font class=z11><b>Описание</b></font>
 </td>
</tr>

<!-- BEGIN reports_entry -->
 <tr>
   <td width="30" align="center" class="z11" height="20" style=" border-bottom: solid 1px #c0c0c0;">
...
<tr>
  <td align="center" class="td_head_ext" colspan="3" width="985"  style="border: solid 1px #c0c0c0;">
   <b>{SHOW_REP_CREATE}</b>
  </td>
</tr>
<tr>
  <td align="left" style="border: solid 1px #c0c0c0; border-top: none;" height=30 width=300>
...
<tr>
  <td align="left"  style="border: solid 1px #c0c0c0; border-top: none;" height=70 width=300>
