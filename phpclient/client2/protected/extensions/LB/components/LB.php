<?php
/**
 * LANBilling application component.
 * Used for registering LANBilling core functionality.
 */
class LB extends CApplicationComponent
{
	...
	{
		if (!Yii::getPathOfAlias('LB'))
			Yii::setPathOfAlias('LB', realpath(dirname(__FILE__).'/..'));
	...
	*/
	protected function getAssetsUrl()
	{
		...
		{
			$assetsPath = Yii::getPathOfAlias('LB.assets');
